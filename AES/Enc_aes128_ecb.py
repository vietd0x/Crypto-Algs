...
ciphertext = b'\x1eIy(\xa5xt\xdb=\x99g\xb4\x12\x80 ^%\x8bu\x18~ w\xf8T\x1c#\xd9\x17\xa97\xed'
...
def sub_bytes(s, sbox=s_box):
    return [[sbox[i] for i in ss] for ss in s]
...
print(decrypt(key, ciphertext[:16]) + decrypt(key, ciphertext[16:]))
